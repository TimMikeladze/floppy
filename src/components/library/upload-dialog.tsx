  ...
  const handleDrop = useCallback(
    (e: React.DragEvent) => {
      ...
      if (e.dataTransfer.files && e.dataTransfer.files.length > 0) {
        const filesWithHandles: FileWithHandle[] = Array.from(
      ...
      <DialogContent className="sm:max-w-md p-0 gap-0 overflow-hidden border-0 bg-transparent shadow-none">
        <div
          ...
          style={{
            background: "var(--card)",
            boxShadow:
              "0 25px 50px -12px oklch(0 0 0 / 0.4), 0 0 0 1px var(--border)",
          }}
        >
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle, oklch(0.78 0.12 70 / 0.2) 0%, transparent 70%)",
            ...
            <div className="relative px-8 pt-12 pb-8">
              ...
              <div className="text-center space-y-2">
                <h3
                  ...
                  style={{
                    color: dragActive ? "var(--primary)" : "var(--foreground)",
                  }}
                >
