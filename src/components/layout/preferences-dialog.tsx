      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-4">
            <h4 className="text-sm font-medium text-muted-foreground">Upload Dialog</h4>

            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                <Label htmlFor="show-comic-sources" className="text-sm font-medium">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => updateSettings({ showComicSources: checked })}
              />
            </div>
          </div>
        </div>
