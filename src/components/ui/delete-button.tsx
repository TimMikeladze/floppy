...
interface DeleteButtonProps extends Omit<React.ComponentProps<"button">, "onClick"> {
  onDelete: () => void
...
export function DeleteButton({
  ...
  const handleDelete = useConfirmDelete(onDelete, { message: confirmMessage, skipConfirmation })
