...
import { FREE_COMICS_SOURCES, CATEGORY_LABELS, type FreeComicSource } from "@/lib/free-comics-sources"
...
export function FreeComicsSources({
  ...
  const sources = maxSources ? FREE_COMICS_SOURCES.slice(0, maxSources) : FREE_COMICS_SOURCES
  ...
  return (
    <div className={className}>
      <div className="flex items-center gap-4 mb-8">
        ...
        <h3 className="text-sm font-medium tracking-widest uppercase">Free Comic Sources</h3>
        <div className="flex-1 h-px bg-border" />
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {(Object.keys(sourcesByCategory) as FreeComicSource["category"][]).map((category) => (
