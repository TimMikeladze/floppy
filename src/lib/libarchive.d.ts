declare module "libarchive.js" {
  ...
  interface ArchiveInstance {
    ...
    getFilesObject(): Promise<Record<string, CompressedFile | Record<string, CompressedFile>>>
    extractFiles(callback?: (entry: { file: File; path: string }) => void): Promise<Record<string, File | Record<string, File>>>
